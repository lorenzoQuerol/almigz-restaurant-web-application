...
const sample = [
	...
	},
	{
		...
		contactNumber: ["(046) 683 - 8752","0935 696 8978"]
	},
	{
...
const Footer = () => {	
	/*	ACTUAL - might need to change "branches"
		...
		/*<footer className="bg-yellow-100 p-7 footer font-rale text-slate-900 footer-center">
			...
			<div>
				...
				<p className="font-bold">
					<a className="mx-3 hover:cursor-pointer hover:underline hover:text-green-800" onClick={handlePrivDialog}>Privacy Policy</a>
					<a className="mx-3 hover:cursor-pointer hover:underline hover:text-green-800" onClick={handleTermsDialog}>Terms and Conditions</a>
					<br />
				</p>
